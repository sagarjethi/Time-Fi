...
import { func, oneOfType, object, string, element, arrayOf, number, instanceOf, any, bool, shape, node, oneOf } from 'prop-types';
import { createContext, createElement, Component, PureComponent, Fragment, forwardRef } from 'react';
...
process.env.NODE_ENV !== "production" ? ModalDialog.propTypes = {
  ...
  onKeyDownInner: func.isRequired,
