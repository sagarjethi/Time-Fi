        ...
        <div class="navbar-menu">
          ...
          <div class="navbar-end">
            <div class="navbar-item">
              <a
                id="source-code"
                href="https://github.com/p2pvid/Time-Fi/backend/blob/main/README.md#faq"
                target="_blank"
            ...
            <div class="navbar-item">
              <a
                id="source-code"
                href="https://github.com/p2pvid/Time-Fi/backend/blob/main/README.md#how-to"
                target="_blank"
                rel="noopener noreferrer"
                >how-to</a
              >
            ...
            <div class="navbar-item">
              <a
                id="source-code"
                href="https://github.com/p2pvid/Time-Fi/backend"
                target="_blank"
                rel="noopener noreferrer"
                >source code</a
              >
